...
<body>
    ...
    <main id="home" class="page-tabs active">
        ...
        <section id="features" class="features">
            ...
            <div class="features-grid">
                <div class="feature-card" onclick="showPage('nutrition')">
                ...
                <div class="feature-card" onclick="showPage('fitness')">
                    <div class="feature-icon">💪</div>
                ...
                <div class="feature-card" onclick="showPage('mental')">
                    <div class="feature-icon">🧠</div>
        ...
        <section class="self-assessment">
            ...
            <form id="assessment-form">
                <div class="assessment-question">
                    ...
                    <div class="rating">
                        <input type="radio" name="anxiety" value="1" id="anxiety1">
                ...
                <div class="assessment-question">
                    ...
                    <div class="rating">
                        <input type="radio" name="energy" value="1" id="energy1">
    ...
    <script>
        ...
        const HealthHubApp = {
            ...
            setupEventListeners: function() {
                ...
                document.querySelectorAll('audio').forEach(audio => {
                    audio.addEventListener('play', () => console.log('Audio playing:', audio.id));
                    audio.addEventListener('ended', () => console.log('Audio ended:', audio.id));
                });
            },
            ...
            updateDailyTip: function() {
                ...
                // Could display this in a notification or tip of the day section
            }
        };
        ...
        function showPage(pageId) {
            ...
            HealthHubApp.currentPage = pageId;
        ...
        function updateTabButtons(pageId) {
            const tabBtns = document.querySelectorAll('.tab-btn');
            tabBtns.forEach(btn => {
                btn.classList.remove('active');
                const btnText = btn.textContent.toLowerCase();
                if (btnText.includes(pageId) || 
                   (pageId === 'home' && btnText.includes('🏠')) ||
                   (pageId === 'nutrition' && btnText.includes('🥗')) ||
                   (pageId === 'fitness' && btnText.includes('💪')) ||
                   (pageId === 'mental' && btnText.includes('🧠')) ||
                   (pageId === 'contact' && btnText.includes('📞'))) {
        ...
        function playAudio(audioId) {
            ...
            if (audio) {
                audio.play().catch(e => {
                    ...
                    showMessage('Could not play audio. Please try again.', 'error');
                });
            }
        }
        ...
        function calculateWater() {
            ...
            if (!weight || isNaN(weight) || weight < 30 || weight > 200) {
                showMessage('Please enter a valid weight between 30 and 200 kg', 'error');
                weightInput.focus();
                return;
            }
            ...
            setTimeout(() => {
                resultElement.textContent = `Recommended Daily Water: ${waterNeeded} liters`;
            ...
            HealthHubApp.userData.preferences.weight = weight;
            HealthHubApp.userData.preferences.waterNeeded = waterNeeded;
            HealthHubApp.saveUserPreferences();
        }
        ...
        function calculateCalories() {
            ...
            if (!duration || isNaN(duration) || duration < 10 || duration > 180) {
                showMessage('Please enter duration between 10 and 180 minutes', 'error');
                document.getElementById('duration').focus();
                return;
            }
            
            if (!weight || isNaN(weight) || weight < 40 || weight > 150) {
                showMessage('Please enter weight between 40 and 150 kg', 'error');
            ...
            setTimeout(() => {
                resultElement.textContent = `Estimated Calories Burned: ${calories} kcal`;
                resultElement.style.opacity = '1';
                resultElement.style.transform = 'translateY(0)';
                resultElement.style.transition = 'opacity 0.3s ease, transform 0.3s ease';
            }, 200);
            ...
            // Save to user preferences
            HealthHubApp.userData.preferences.lastActivity = {
                type: activity,
                duration: duration,
                weight: weight,
        ...
        function calculateAssessment() {
            ...
            setTimeout(() => {
                scoreElement.textContent = averageScore + '/5';
                scoreElement.style.opacity = '1';
                scoreElement.style.transform = 'scale(1)';
                scoreElement.style.transition = 'opacity 0.3s ease, transform 0.3s ease';
            }, 200);
            ...
            HealthHubApp.assessmentScore = averageScore;
            HealthHubApp.userData.preferences.lastAssessment = {
                score: averageScore,
        ...
        function submitContactForm() {
            ...
            setTimeout(() => {
                ...
                showMessage('Message sent successfully! We will get back to you within 24-48 hours.', 'success');
                ...
                HealthHubApp.userData.name = name;
                HealthHubApp.userData.email = email;
                HealthHubApp.userData.preferences.newsletter = newsletter;
                HealthHubApp.saveUserPreferences();
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (hash && ['home', 'nutrition', 'fitness', 'mental', 'contact'].includes(hash)) {
                showPage(hash);
            }
            
            // Add clickable feature to all cards
